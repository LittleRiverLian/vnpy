...
class TurtleSignal(object):
    ...
    def __init__(self, portfolio, vtSymbol,
        ...
        self.entryDev = 1  # 入场通道宽度
        self.exitDev = 0  # 出场通道宽度
    ...
    def generateSignal(self, bar):
        ...
        if self.unit >= 0:
            ...
            if bar.high_price >= self.longEntry1 and self.unit < 4:
                self.buy(self.longEntry1, 4)
                trade = True
        ...
        if self.unit <= 0:
            if bar.low_price <= self.shortEntry1 and self.unit > -4:
                self.short(self.shortEntry1, 4)
...
class TurtlePortfolio(object):
    ...
    def init(self, portfolioValue, vtSymbolList, sizeDict):
        ...
        for vtSymbol in vtSymbolList:
            ...
            signal2 = TurtleSignal(self, vtSymbol, 55, 20, 20, True)
